...
/*
 * Clock frequencies of System Buses
 */

#define AHB1_CLK_SPEED          168000000U
#define AHB2_CLK_SPEED          AHB1_CLK_SPEED
#define APB1_CLK_SPEED          42000000U
#define APB2_CLK_SPEED          84000000U
...
/*
 * Pointers to USART Base addresses
 */
#define USART1                ((USART_RegDef_t*)USART1_BASE_ADDR)
#define USART2                ((USART_RegDef_t*)USART2_BASE_ADDR)
#define USART3                ((USART_RegDef_t*)USART3_BASE_ADDR)
#define USART6                ((USART_RegDef_t*)USART6_BASE_ADDR)
#define USART7                ((USART_RegDef_t*)USART7_BASE_ADDR)
#define USART8                ((USART_RegDef_t*)USART8_BASE_ADDR)
...
/*
 * Bit Positions for USART CR2 Register
 *
 */
...
/*
 * Bit Positions for USART CR3 Register
 */
...
/*
 * Clock Enable and Disable Macros for USART Port
 */
...
/*
 * Deinitialize the USART port by resetting it
 */

#define USART1_RST()              (RCC->APB2RSTR |= (1<<4))
#define USART6_RST()              (RCC->APB2RSTR |= (1<<5))
#define USART2_RST()              (RCC->APB1RSTR |= (1<<17))
#define USART3_RST()              (RCC->APB1RSTR |= (1<<18))
#define UART4_RST()               (RCC->APB1RSTR |= (1<<19))
#define UART5_RST()               (RCC->APB1RSTR |= (1<<20))
